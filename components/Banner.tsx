...
const Banner = () => {
  return (
    <View className="rounded-lg  items-center">
        <View
        className='absolute w-full h-[90px] -top-2 items-center bg-[#222222] pb-10'
        />
            <Image   
            ...
            {/* Promo Badge */}
        <Text
            className='bg-app_gold_color rounded-lg text-white mb-1 text-m p-1.5 font-[Sora-SemiBold] self-start'
            >Promo</Text>
            {/* Promo Title */}
